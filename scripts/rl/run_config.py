...
PROVENANCE: verbatim copy of github.com/ceselder/skip-lens @ 13547ae, nla/utils/run_config.py
(self-contained: argparse + yaml only). See docs/project/experiments/ola/skip_lens_audit.md.
